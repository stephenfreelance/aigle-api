...
from core.serializers.geo_department import GeoDepartmentDetailSerializer, GeoDepartmentSerializer
...
class GeoDepartmentViewSet(DeletableModelViewSetMixin[GeoDepartment], CountableModelViewSetMixin, ModelViewSet):
    lookup_field = "uuid"
